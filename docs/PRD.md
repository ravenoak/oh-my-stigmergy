...
- **OpenCode cognitive bridge (FR-5.x, [ADR-0012](adr/0012-opencode-plugin-architecture.md))** — in-tree [`packages/opencode-plugin`](../../packages/opencode-plugin/) wiring OpenCode to SBP HTTP and graph CLIs; **maturity** follows [ROADMAP.md](ROADMAP.md) Phase 11 (P11-a scaffold → P11-b `implemented`).
