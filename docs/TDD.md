...
**Orchestrator vs medium:** Third-party harnesses (for example [oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent)) optimize **who delegates to whom** inside their product. This repository implements **stigmergic** coordination — ledger-visible state and policy-driven routing — via [`packages/opencode-plugin`](../../packages/opencode-plugin/) ([ADR-0012](adr/0012-opencode-plugin-architecture.md), [ADR-0013](adr/0013-stigmergic-opencode-orchestration.md), [ADR-0014](adr/0014-sbp-project-supervision.md), FR-5.x / FR-6.x), **not** an in-tree mega-orchestrator prompt ([ADR-0003](adr/0003-stigmergy-vs-orchestrator.md)).

| Layer | Component | Technology (essay / options) | Status |
|-------|-----------|------------------------------|--------|
| Cognitive | Stance-driven agents | OpenCode + in-tree stigmergy bridge ([`packages/opencode-plugin`](../../packages/opencode-plugin/) — FR-5.x incl. supervision, FR-6.x, FR-7.1 evaluation discipline + FR-7.2 effectiveness study protocol), Cursor, other editors and models | **Concrete** — `StigmergyPlugin` with SBP + graph tools + orchestration helpers (`stigmergy_actionable`, `stigmergy_resolve_model`); project-local SBP supervision when **`SBP_URL`** unset ([ADR-0014](adr/0014-sbp-project-supervision.md)); golden path + migration + operator playbook / compatibility / release + **positioning + SDLC workflow** docs + essay errata + **troubleshooting** + **empirical discipline** ([`docs/guides/opencode-stigmergy-golden-path.md`](guides/opencode-stigmergy-golden-path.md), [`docs/guides/migration-from-oh-my-openagent.md`](guides/migration-from-oh-my-openagent.md), [`docs/guides/opencode-model-routing-playbook.md`](guides/opencode-model-routing-playbook.md), [`docs/guides/project-positioning-and-boundaries.md`](guides/project-positioning-and-boundaries.md), [`docs/guides/stigmergic-sdlc-workflows.md`](guides/stigmergic-sdlc-workflows.md), [`docs/guides/stigmergy-evaluation-discipline.md`](guides/stigmergy-evaluation-discipline.md), [`docs/inspiration-errata.md`](inspiration-errata.md), [`docs/operations/opencode-stigmergy-troubleshooting.md`](operations/opencode-stigmergy-troubleshooting.md), [`docs/operations/opencode-compatibility.md`](operations/opencode-compatibility.md)); other editors remain external |
