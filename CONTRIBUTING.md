...
See [packages/opencode-plugin/README.md](packages/opencode-plugin/README.md) for **capabilities, limitations, installation, configuration, tools, and usage** (humans and coding agents).
